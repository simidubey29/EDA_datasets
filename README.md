...
**Movies and TV Shows on Netflix – Exploratory Data Analysis (EDA)**

> ✅ This project clearly falls under **EDA (Exploratory Data Analysis)** as it focuses on understanding, cleaning, and visualizing the Netflix dataset to uncover patterns and insights.
...
EDA helps in understanding the structure of the dataset, identifying missing values, and visualizing trends before applying any machine learning or advanced analytics.
...
* Save visual outputs for documentation and reporting
...
Give this repository a ⭐ on GitHub to support and motivate further work!
